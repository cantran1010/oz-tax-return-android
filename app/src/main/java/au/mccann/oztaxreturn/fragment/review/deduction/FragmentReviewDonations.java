 ...
 */
public class FragmentReviewDonations extends BaseFragment implements View.OnClickListener {
    private static final String TAG = FragmentReviewDonations.class.getSimpleName();
